...
public class Form_01_DuAnNangCap extends JFrame {
	...
	public Form_01_DuAnNangCap() {
		...
		tabbedPane.setBounds(0, 0, 471, 468);
		...
		btnXoa.setIcon(new ImageIcon(Form_01_DuAnNangCap.class.getResource("/images/delete.png")));
		...
		btnCapNhat.setIcon(new ImageIcon(Form_01_DuAnNangCap.class.getResource("/images/update.png")));
		...
		btnRefresh.setIcon(new ImageIcon(Form_01_DuAnNangCap.class.getResource("/images/refresh.png")));
		...
		btnXn.setEnabled(false);
		btnXn.setIcon(new ImageIcon(Form_01_DuAnNangCap.class.getResource("/images/tick.png")));
		...
		btnThm.setIcon(new ImageIcon(Form_01_DuAnNangCap.class.getResource("/images/add.png")));
